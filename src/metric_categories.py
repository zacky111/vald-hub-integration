TEST_TYPE_METRIC_CATEGORIES = {
    ...
    "SLJ": {
        "Output": ["JUMP_HEIGHT_IMP_MOM",
                   "RSI_MODIFIED",
                   "BODYMASS_RELATIVE_TAKEOFF_POWER",
                   "TAKEOFF_VELOCITY",
                   "FORCE_AT_PEAK_POWER"],
        "Monitoring": ["BODY_WEIGHT",
        ...
        "Unweighting": ["MIN_ECCENTRIC_FORCE"],
        "Landing": ["PEAK_LANDING_FORCE",
                     "LANDING_IMPULSE"],
        "Eccentric": ["ECCENTRIC_PEAK_VELOCITY",
                       "ECCENTRIC_TIME",
